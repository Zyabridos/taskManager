...
test.describe('users CRUD visual (UI)', () => {
  ...
  //   await signUpNewUser(page, email, faker.internet.password(8));
  //   console.log('newUserEmail', newUserEmail);

  //   console.log('going to userData.url.usersList', userData.url.usersList);
  //   page.goto(userData.url.usersList);
  //   const row = page.locator(`[data-email="${newUserEmail}"]`);
  //   console.log('got a user row', row);
  //   console.log('text inside btn is userData.buttons.edit', userData.buttons.edit);
