...
This command will launch the app. By default, the app should be accessible at [[http://0.0.0.0:3000](http://0.0.0.0:3000)](http://localhost:5001/). If you cannot access the app, check the terminal output for the correct URL or any errors related to the server startup.
